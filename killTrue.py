...
async def killT(bot, querty: CallbackQuery, bullets, kol_objects, sum, play_live, opponent_live, kol, damage, skotch, objects, opponent_objects):
    ...
    if opponent_live <= 0:
        ...
        return bullets, kol_objects, sum, play_live, opponent_live, kol, damage, skotch, objects, opponent_objects
    else:
        if not skotch:
