...
async def killT(bot, querty: CallbackQuery, bullets, kol_objects, sum, play_live, opponent_live, kol, damage, skotch, objects):
    ...
    if opponent_live <= 0:
        ...
        if not skotch:
            ...
            return bullets, kol_objects, sum, play_live, opponent_live, kol, damage, skotch, objects
        else:
            skotch = False
            print("T-> " + str(skotch))
            if len(bullets) == 0:
